...
{trigger: /(w|z)(xy|ab)/, replacement: (s) => `${s[1]} = ${s[2][0]} + i${s[2][1]}`, options: "mA"},
...
{trigger: /11([i-n])/, replacement: (s) => `\\mathbb{1}_{${l(s[1])}}`, options: "mA"},
{trigger: /\\mathbb\{1\}_\{([ijkmn]|\\ell)\}([2-9])/, replacement: "\\mathbb{1}_{[[1]]}", options: "mA"},
{trigger: /(C|L)([\di-o])/, replacement: (s) => `${s[1]}^{${l(o(s[2]))}}`, options: "mA"},
{trigger: /(c?)(p?)([B-Db-d])([RSrs])([W-Zow-z])/, replacement: (s) => `${s[1] == "c" ? "\\overline{" : ""}${s[3].toUpperCase()}${s[2] == "p" ? "^{*}" : ""}_{${s[4]}}(${o(s[5])})${s[1] == "c" ? "}" : ""}`, options: "mA"},
...
{trigger: /(n?)sq/, replacement: (s) => `\\sqrt${s[1] == "n" ? "[$0]" : ""}{$1}$2`, options: "mA"},
{trigger: /tpd/, replacement: "^{\\top}", options: "mA"},
{trigger: /conj|dual/, replacement: "^{*}", options: "mA"},
...
{trigger: /([abcfgu-z])([i-n])\2/, replacement: (s) => `${s[1]}_{${l(s[2])}}`, options: "mA", priority: 1},
{trigger: /\\xii/, replacement: "x_{i}", options: "mA", priority: 2},
{trigger: /([abcfgu-z])([i-n]?)(p|m)([1-3])/, replacement: (s) => `${s[1]}_{${s[2] == "" ? "n" : l(s[2])}${s[3] == "p" ? "+" : "-"}${s[4]}}`, options: "mA"},
//{trigger: /([abcfgu-z])nk/, replacement: "[[0]]_{n_{k}}", options: "mA"},
{trigger: /-1([i-n])/, replacement: (s) => `(-1)^{${l(s[1])}}`, options: "mA"},
