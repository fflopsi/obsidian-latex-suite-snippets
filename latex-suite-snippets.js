...
function d(s) {
  const deco = {
    cek: "check", dvc: "dot vec", ddvc: "ddot vec", lbr: "overline", ring: "mathring", und: "underline", wht: "widehat", wtd: "widetilde", "~": "tilde",
  };
...
{trigger: /(d)iff/, replacement: "[[0]]ifferent", options: "t", flags: "i"},
{trigger: /(i)nt/, replacement: "[[0]]ntegr", options: "t", flags: "i"},
...
{trigger: /(P)oly?/, replacement: "[[0]]olynom", options: "t", flags: "i"},
...
{trigger: /(k)an/, replacement: "[[0]]anonisch", options: "t", flags: "i"},
...
{trigger: /(Re|Im|sgn|Tr|End|Hom|span|adj|grad|div|rot|vol|spt|Sym|Alt|Arg|ord|Stab|diag)/, replacement: "\\operatorname{[[0]]}", options: "mA"},
...
{trigger: /(b?)o\+/, replacement: m => `\\${m[1] == "b" ? "big" : ""}oplus`, options: "mA"},
{trigger: /o-/, replacement: "\\ominus", options: "mA"},
{trigger: /(b?)ox/, replacement: m => `\\${m[1] == "b" ? "big" : ""}otimes`, options: "mA"},
...
{trigger: /(n?)exi/, replacement: "\\[[0]]exists", options: "mA", priority: 1},
...
{trigger: /(zsum|zprod)/, replacement: m => `\\${m[1].slice(1)}_{$\{0:n\} \\in $\{1:\\mathbb{Z}\}} $3`, options: "mA", priority: 1},
